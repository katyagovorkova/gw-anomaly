...
def get_evals(data_, model_path, savedir, start_point, gwpy_timeseries):
    ...
    for hour_split in range(N_one_hour_splits):
        ...
        model_path = ["/home/eric.moreno/QUAK/ryan_checks/models/bbh.pt",
                      "/home/eric.moreno/QUAK/ryan_checks/models/sglf.pt",
                      "/home/eric.moreno/QUAK/ryan_checks/models/sghf.pt",
                      "/home/eric.moreno/QUAK/ryan_checks/models/background.pt",
                      "/home/eric.moreno/QUAK/ryan_checks/models/glitches.pt"]
...
def main(args):
    ...
    f_segments = 'output/NEWMODEL_done_O3a_segments.npy'

...
from utils.dataloading import get_prefix
...
class Searcher:
    def __init__(
        ...
        # background_file = f"{outdir}/{infer}/background.h5"
        ...
        # num_events = 100 # np.floor(fars_per_day * self.background.Tb / 3600 / 24)
    ...
    def search(self, y: np.ndarray, t0: float):
        ...
        *first sample* of the integration window.
        ...
        if idx < (len(y) - 1):
            ...
            return self.build_event(min_val, t0, idx)
        else:
